...
app.post('/set', function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        yield withExponentialBackoff(setValue, 1, req.body.set_text_key, req.body.set_text_value);
        return res.redirect('/');
    });
});
/**
...
app.post('/delete', function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (map.has(key)) {
            ...
            yield withExponentialBackoff(deleteKey, 1, key);
...
function getMap() {
    return __awaiter(this, void 0, void 0, function* () {
        const result = yield withExponentialBackoff(getFunction);
 ...
 * */
// @ts-ignore
function withExponentialBackoff(func, backoffTime = 1, ...args) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield withCircuitBreaker(func, ...args)
            .then()
            .catch((e) => {
            const nextBackoffTime = backoffTime * 1.15;
            console.error(e.message + ' Next try in: ' + nextBackoffTime + ' seconds.');
            return new Promise((resolve) => setTimeout(() => resolve(withExponentialBackoff(func, nextBackoffTime, ...args)), nextBackoffTime * 1000));
        });
    });
}
/**
...
function withCircuitBreaker(func, ...args) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield breaker.fire(func, ...args).then();
    });
}
/**
